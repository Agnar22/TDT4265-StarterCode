...
if __name__ == "__main__":
  ...
  print(f'Train loss for worst model: {task2.compute_loss_and_accuracy(dataloaders[0], worst_trainer.model, worst_trainer.loss_criterion)[0]}')
  ...
  # Task 3 b)
  print(f'Train loss for best model: {task2.compute_loss_and_accuracy(dataloaders[0], best_trainer.model, best_trainer.loss_criterion)[0]}')
